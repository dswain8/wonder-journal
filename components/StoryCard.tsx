...
function playGuideChime(guide: WonderGuideId) {
  ...
  const frequencies = guide === 'nachiketh' ? [523.25, 659.25] : [659.25, 880];
...
export default function StoryCard({
  ...
  useEffect(() => {
    if (hasStory && storyStatus === 'ready') {
      setShowStory(true);
    }
  }, [hasStory, storyStatus]);
  ...
  const toggleReadAloud = async (mode: NarrationMode) => {
    ...
    const voiceId = guide === 'gargi' ? '8dRG2ER7ThdAWJwK71hG' : 'txk8uOzZ0iCh0B9mFSRG';
        ...
        <div className="relative px-4 pb-6 pt-4 lg:px-8 lg:pb-8 lg:pt-8">
          ...
          <div className="mt-4 rounded-[22px] bg-white/6 p-4 shadow-[inset_0_0_0_1px_rgba(246,238,221,0.14)] lg:mt-0">
            <div className="flex items-center gap-3">
              ...
              {isAudioLoading && (
                <span className="rounded-full bg-white/8 px-2.5 py-1 text-left text-[11px] font-bold text-white/68 transition hover:bg-white/12">
              ...
              <div className="wj-parchment wj-page-in rounded-t-[26px] px-5 py-5">
                ...
                <div className="mt-4 rounded-[20px] bg-[#fff7e3] p-3 shadow-[inset_0_0_0_1px_rgba(142,68,18,0.1)]">
                  ...
                  >
                    ...
                    <span className="shrink-0 text-[11px] font-bold text-[var(--wj-terracotta)]"></span>
                  </button>
          ...
          {onAskAnother ? (
            <motion.button
              ...
              className="wj-primary-btn mt-5 w-full backdrop-blur-sm"
            >
